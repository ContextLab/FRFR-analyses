...
their recalls along the given feature dimension.
...
clustering score for the participant. Finally, as with the feature-based
clustering scores, we applied our permutation correction procedure to obtain a
corrected clustering score.
