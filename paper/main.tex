...
A core assumption of our approach is that each participant organizes
their memories in a unique way. We defined each participant's \textit{memory
...
[-2.461, 1.645]$; reduced, word length: $t(60) = 3.762, p < 0.001, d = 0.261,
...
category: $t(40) = -0.101, p = 0.920, d = -0.009, \mathrm{CI} = [-2.307,
1.776]$; reduced (late), size: $t(40) = 0.555, p = 0.582, d = 0.058,
\mathrm{CI} = [-1.444, 2.274] $; reduced (late), length: $t(40) = 1.482, p =
0.146, d = 0.126, \mathrm{CI} = [-0.444, 3.743]$; reduced (late), first letter:
$t(40) = -0.143, p = 0.887, d = -0.017, \mathrm{CI} = [-2.204, 1.830] $). We
...
described above, a participant's memory fingerprint describes how they tend to
