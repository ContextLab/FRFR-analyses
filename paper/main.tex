...
% negative priming: supressing previously irrelevant stimuli or features hurts participants' recall for those stimuli when they're used on subsequent lists
...
influence how we are likely to resolve ambiuities. For example, before
listening to a story with several equally plausable interpretations, providing
...
interpret high-level ambuities, but even how we process low-level sensory
...
and how they remember. For example, when participants are directed to supress,
...
that the temporal unfoldings of events and occurances in naturalistic stimuli
...
stimulus, or from idiosyncratic interactions or inteference between our memory
...
real-world experiences) measures of the relevant patterns and tendancies.
...
are suceptable to external influences (i.e., to the statistical structure of
...
Our work raises deep questiong about the fundamental nature of human learning.
...
expermental conditions may be found at
