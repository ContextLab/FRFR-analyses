...
these order manipulation results suggest several broad patterns. First, most of
the order manipulations we carried out did \textit{not} reliably affect overall
...
%%%%%
% - next paragraph: relative strengths of order manipulations (compare order manipulations to *other order manipulations* instead of feature rich)

% - and then, another paragraph: stickiness-- compare results on late lists (order manip vs. feature rich, order manip vs. other order manip).
