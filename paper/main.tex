...
(all lists).} The $t$-tests reported in the table were carried out
...
\caption{\textbf{Comparing temporal clustering on early lists in the order manipulation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
\caption{\textbf{Comparing feature-based clustering on early lists in the semantic order manipulation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
\caption{\textbf{Comparing feature-based clustering on early lists in the lexicographic order manipulation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
\caption{\textbf{Comparing feature-based clustering on early lists in the visual order manipulation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
\caption{\textbf{Comparing temporal clustering on late lists in order-manipulatation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all late
lists from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
\caption{\textbf{Comparing feature-based clustering on late lists in semantic order-manipulatation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all late
lists from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
lexicographic order-manipulatation versus feature-rich conditions.} The
...
\caption{\textbf{Comparing feature-based clustering on late lists in visual order-manipulatation
versus feature-rich conditions.} The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all late
lists from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}
...
conditions: $r(4) = 0.064,~p = 0.903,~\mathrm{CI} = [-0.972,~0.965$). Taken together,
