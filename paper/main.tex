...
locaiton), and a final adaptive condition. Each of these conditions are
...
synchronize the experiment databases across multiple testing computers.)
A complete report... %STOPPED HERE
...
length, and starting letter (Fig.~\ref{fig:exp1}). Each list contains four
words from each of four different semantic categories; all other stimulus
