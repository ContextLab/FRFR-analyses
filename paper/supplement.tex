...
dynamics for early lists in each condition, and bottom
panels display the recall dynamics for late lists.}
...
\begin{figure}[tp] \centering
    ...
    (across-participant) average memory fingerprint for a single list. Early lists
    ...
    between each per-list memory fingerprint and the average fingerprint across all
    ...
    \begin{figure}[tp] \centering
        ...
        coefficients are displayed in their corresponding cells of the heatmap.} \label{fig:feature-correlations}
