...
%DIF ADD main.tex   Tue Nov 14 23:13:20 2023
...
how we remember }\textit{\DIFadd{those}} \DIFadd{experiences, and also how we remember
...
important differences in which dimensions influence participants' memories? Or
...
temporal) reported in this paper. \DIFaddbegin \DIFadd{In Figure~\clusterCorrs~we report how
...
clustering score will }\textit{\DIFadd{also}} \DIFadd{tend to be correlated with the clustering
...
position) was recalled at output position $n$~\mbox{%DIFAUXCMD
...
and \DIFdelbegin \DIFdel{successive }\DIFdelend repetitions (i.e., recalling \DIFdelbegin \DIFdel{the same word twice in
a row}\DIFdelend \DIFaddbegin \DIFadd{a word that had already appeared previously in
the current recall sequence}\DIFaddend ). This yielded, for each list, a 1 by
...
\DIFaddbegin \subsection*{\DIFadd{Data and code availability}}
...
words) for feature rich versus reduced lists (\DIFdelbegin \DIFdel{$t(126) = -0.290, p = 0.772$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = -0.290, p = 0.772,
\mathrm{Cohen's}~d~(d) = -0.051,
\mathrm{bootstrap~estimated~95\%~confidence~interval}~(\mathrm{CI}) = [-2.387,
1.768]$}\DIFaddend ). However, participants in the feature rich condition clustered their
recalls substantially more along every dimension we examined (temporal
clustering: \DIFdelbegin \DIFdel{$t(126) = 10.624, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 10.632, p < 0.001, d = 1.882, \mathrm{CI} = [7.786,
14.386]$}\DIFaddend ; semantic category clustering: \DIFdelbegin \DIFdel{$t(126) = 10.077, p
< 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 10.148, p < 0.001, d = 1.796,
\mathrm{CI} = [7.324, 13.778] $}\DIFaddend ; size clustering: \DIFdelbegin \DIFdel{$t(126) = 11.829, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 12.033, p < 0.001,
d = 2.129, \mathrm{CI} = [9.030, 15.918]$}\DIFaddend ; word length clustering: \DIFdelbegin \DIFdel{$t(126) = 10.639, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) =
10.720, p < 0.001, d = 1.897, \mathrm{CI} = [7.442, 15.174]$}\DIFaddend ; first letter
clustering: \DIFdelbegin \DIFdel{$t(126) =
7.775, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 6.679, p < 0.001, d = 1.182, \mathrm{CI} = [4.490,
9.611]$}\DIFaddend ; see \textit{Permutation-corrected feature clustering scores} for more
...
\DIFdelbegin \DIFdel{We also wondered }\DIFdelend \DIFaddbegin \DIFadd{A core assumption of our approach is that each participant organizes their
...
\DIFadd{We next asked }\DIFaddend whether adding these incidental visual features to later lists
...
\DIFdelbegin \DIFdel{$t(66) = 4.553, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(66) = 4.553, p < 0.001, d = 0.233, \mathrm{CI} = [2.427, 7.262]$}\DIFaddend ; reduced:
\DIFdelbegin \DIFdel{$t(60) = 2.434, p = 0.018$}\DIFdelend \DIFaddbegin \DIFadd{$t(60) = 2.434, p = 0.018, d = 0.134, \mathrm{CI} = [0.493, 4.910]$}\DIFaddend ).
Participants in the feature rich (but not reduced) conditions exhibited more
temporal clustering on early versus late lists (feature rich: \DIFdelbegin \DIFdel{$t(66) = 2.318, p =
0.024$}\DIFdelend \DIFaddbegin \DIFadd{$t(66) = 2.268, p
= 0.027, d = 0.181, \mathrm{CI} = [0.437, 4.425]$}\DIFaddend ; reduced: \DIFdelbegin \DIFdel{$t(60) = 0.929, p = 0.357$}\DIFdelend \DIFaddbegin \DIFadd{$t(60) = 0.986, p =
0.328, d = 0.061, \mathrm{CI} = [-0.897, 3.348]$}\DIFaddend ). And participants in both
conditions \DIFdelbegin \DIFdel{exhibited more semantic (category and size) }\DIFdelend \DIFaddbegin \DIFadd{tended to exhibit more semantic }\DIFaddend clustering on early versus late
lists (feature rich, category: \DIFdelbegin \DIFdel{$t(66) = 3.805, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(66) = 3.684, p < 0.001, d = 0.220,
\mathrm{CI} = [1.733, 5.732]$}\DIFaddend ; feature rich, size: \DIFdelbegin \DIFdel{$t(66) = 2.190, p = 0.032$}\DIFdelend \DIFaddbegin \DIFadd{$t(66) = 1.629, p = 0.108, d
= 0.100, \mathrm{CI} = [-0.207, 3.905] $}\DIFaddend ; reduced, category: \DIFdelbegin \DIFdel{$t(60) = 2.856, p =
0.006$}\DIFdelend \DIFaddbegin \DIFadd{$t(60) = 2.755, p
= 0.008, d = 0.177, \mathrm{CI} = [0.761, 5.189]$}\DIFaddend ; reduced, size: \DIFdelbegin \DIFdel{$t(60) = 2.947, p = 0.005$}\DIFdelend \DIFaddbegin \DIFadd{$t(60) =
3.081, p = 0.003, d = 0.201, \mathrm{CI} = [1.210, 5.326]$}\DIFaddend ). Participants in
the reduced (but not feature rich) conditions \DIFdelbegin \DIFdel{exhibited }\DIFdelend \DIFaddbegin \DIFadd{tended to exhibit }\DIFaddend more
lexicographic clustering on early versus late lists (feature rich, word length:
\DIFdelbegin \DIFdel{$t(66) = 0.161, p = 0.872$}\DIFdelend \DIFaddbegin \DIFadd{$t(66) = -0.100, p = 0.921, d = -0.010, \mathrm{CI} = [-2.217, 1.899]$}\DIFaddend ; feature
rich, first letter: \DIFdelbegin \DIFdel{$t(66) = 0.410, p = 0.683$}\DIFdelend \DIFaddbegin \DIFadd{$t(66) = 0.412, p = 0.681, d = 0.045, \mathrm{CI} =
[-1.645, 2.461]$}\DIFaddend ; reduced, word length: \DIFdelbegin \DIFdel{$t(60) = 3.528, p = 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(60) = 3.762, p < 0.001, d = 0.261,
\mathrm{CI} = [1.604, 6.821]$}\DIFaddend ; reduced, first letter: \DIFdelbegin \DIFdel{$t(60) = 2.275, p = 0.026$}\DIFdelend \DIFaddbegin \DIFadd{$t(60) = 1.721, p =
0.090, d = 0.175, \mathrm{CI} = [-0.138, 4.098]$}\DIFaddend ). Taken together, these
...
participants tended to \DIFdelbegin \DIFdel{remember more words and }\DIFdelend exhibit stronger clustering effects on feature rich
...
versus late differences in accuracy (reduced (early): \DIFdelbegin \DIFdel{$t(41) =
1.499, p = 0.141$}\DIFdelend \DIFaddbegin \DIFadd{$t(41) = 1.499, p =
0.141, d = 0.098, \mathrm{CI} = [-0.345, 3.579]$}\DIFaddend ; reduced (late): \DIFdelbegin \DIFdel{$t(40) = 1.462, p = 0.152$}\DIFdelend \DIFaddbegin \DIFadd{$t(40) =
1.462, p = 0.152, d = 0.121, \mathrm{CI} = [-0.376, 2.993]$}\DIFaddend ), temporal
clustering (reduced (early): \DIFdelbegin \DIFdel{$t(41) = 0.998, p = 0.324$}\DIFdelend \DIFaddbegin \DIFadd{$t(41) = 0.857, p = 0.396, d = 0.068, \mathrm{CI}
= [-1.012, 2.896]$}\DIFaddend ; reduced (late): \DIFdelbegin \DIFdel{$t(40)
= 1.099, p = 0.278$}\DIFdelend \DIFaddbegin \DIFadd{$t(40) = 1.244, p = 0.221, d = 0.128,
\mathrm{CI} = [-0.894, 3.088]$}\DIFaddend ), nor feature-based clustering (reduced (early),
category: \DIFdelbegin \DIFdel{$t(41) = 0.753, p = 0.456$}\DIFdelend \DIFaddbegin \DIFadd{$t(41) = 0.707, p = 0.484, d = 0.068, \mathrm{CI} = [-1.314, 2.830]$}\DIFaddend ;
reduced (early), size: \DIFdelbegin \DIFdel{$t(41) = 0.721, p = 0.475$}\DIFdelend \DIFaddbegin \DIFadd{$t(41) = 0.803, p = 0.427, d = 0.079, \mathrm{CI} =
[-1.142, 2.953]$}\DIFaddend ; reduced (early), length: \DIFdelbegin \DIFdel{$t(41) = 0.493, p = 0.625$}\DIFdelend \DIFaddbegin \DIFadd{$t(41) = 0.461, p = 0.648, d =
0.060, \mathrm{CI} = [-1.545, 2.462]$}\DIFaddend ; reduced (early), first letter: \DIFdelbegin \DIFdel{$t(41) = 0.780, p = 0.440$}\DIFdelend \DIFaddbegin \DIFadd{$t(41) =
0.781, p = 0.439, d = 0.101, \mathrm{CI} = [-1.039, 2.881]$}\DIFaddend ; reduced (late),
category: \DIFdelbegin \DIFdel{$t(40) = -0.086,
p = 0.932$}\DIFdelend \DIFaddbegin \DIFadd{$t(40) = 0.101, p = 0.920, d = 0.009, \mathrm{CI} = [-1.776, 2.307]$}\DIFaddend ;
reduced (late), size: \DIFdelbegin \DIFdel{$t(40) = 0.746, p = 0.460$}\DIFdelend \DIFaddbegin \DIFadd{$t(40) = 0.555, p = 0.582, d = 0.058, \mathrm{CI} =
[-1.444, 2.274] $}\DIFaddend ; reduced (late), length: \DIFdelbegin \DIFdel{$t(40) = 1.476, p = 0.148$}\DIFdelend \DIFaddbegin \DIFadd{$t(40) = 1.482, p = 0.146, d =
0.126, \mathrm{CI} = [-0.444, 3.743]$}\DIFaddend ; reduced (late), first letter: \DIFdelbegin \DIFdel{$t(40) =
0.966, p = 0.340$}\DIFdelend \DIFaddbegin \DIFadd{$t(40) =
-0.143, p = 0.887, d = -0.017, \mathrm{CI} = [-2.204, 1.830] $}\DIFaddend ). We
...
\DIFdelbegin \DIFdel{$t(107) = -2.230, p = 0.028$}\DIFdelend \DIFaddbegin \DIFadd{$t(107) = -2.230, p = 0.028, d = -0.439, \mathrm{CI} = [-4.252, -0.229]$}\DIFaddend ;
reduced versus reduced (early): \DIFdelbegin \DIFdel{$t(101) = -2.045,
p = 0.043$}\DIFdelend \DIFaddbegin \DIFadd{$t(101) = -2.045, p = 0.043, d = -0.410,
\mathrm{CI} = [-3.826, 0.112]$}\DIFaddend ; also see Fig.~\accuracyByList A). However,
...
reduced (late): \DIFdelbegin \DIFdel{$t(106) =
-0.638, p = 0.525$}\DIFdelend \DIFaddbegin \DIFadd{$t(106) = -0.638, p = 0.525, d = -0.126, \mathrm{CI} = [-2.720,
1.362]$}\DIFaddend ; reduced versus reduced (late): \DIFdelbegin \DIFdel{$t(100) = -0.407, p =
0.685$}\DIFdelend \DIFaddbegin \DIFadd{$t(100) = -0.407, p = 0.685, d =
-0.082, \mathrm{CI} = [-2.477, 1.626]$}\DIFaddend ). These comparisons suggest that recall
...
$t$s \DIFdelbegin \DIFdel{$\leq
-9.780$}\DIFdelend \DIFaddbegin \DIFadd{$\leq -9.885$}\DIFaddend , $p$s $< 0.001$; feature-based clustering in reduced versus
reduced (early) and reduced versus reduced (late) conditions: $t$s \DIFdelbegin \DIFdel{$\leq -5.443$}\DIFdelend \DIFaddbegin \DIFadd{$\leq
-4.555$}\DIFaddend , $p$s $< 0.001$). Temporal and feature-based clustering were not
...
feature rich versus reduced (late) conditions: $t$s \DIFdelbegin \DIFdel{$\geq -1.434$}\DIFdelend \DIFaddbegin \DIFadd{$\geq -1.379$}\DIFaddend , $p$s \DIFdelbegin \DIFdel{$\geq 0.154$}\DIFdelend \DIFaddbegin \DIFadd{$\geq
0.171$}\DIFaddend ; feature-based clustering in feature rich versus reduced (early) and
feature rich versus reduced (late) conditions: \DIFdelbegin \DIFdel{$t$s $\geq -1.359$}\DIFdelend \DIFaddbegin \DIFadd{$|t|$s $\leq 1.441$}\DIFaddend , $p$s \DIFdelbegin \DIFdel{$> 0.177$}\DIFdelend \DIFaddbegin \DIFadd{$\geq
0.153$}\DIFaddend ).
...
random and adaptive conditions. \textbf{B.} \DIFaddbeginFL \DIFaddFL{Feature distances ($z$-scored
within condition) between the features of successively presented words (see
}\textit{\DIFaddFL{Defining feature-based distances}}\DIFaddFL{), for each condition's feature of
focus, plotted as a function of presentation position.}\textbf{\DIFaddFL{C.}} \DIFaddendFL Proportion of
...
early feature rich lists; \DIFdelbegin \DIFdel{$t(95) = 3.034, p = 0.003$}\DIFdelend \DIFaddbegin \DIFadd{$t(95) = 3.034, p = 0.003, d = 0.667, \mathrm{CI} =
[1.048, 5.113]$}\DIFaddend ). Participants in the color-ordered condition also showed a
trending increase in memory performance on early lists (again, relative to
early feature rich lists: \DIFdelbegin \DIFdel{$t(96) = 1.850, p
= 0.067$}\DIFdelend \DIFaddbegin \DIFadd{$t(96) = 1.850, p = 0.067, d = 0.402, \mathrm{CI} =
[-0.010, 3.712]$; Fig.~\ref{fig:barplots}A}\DIFaddend ). Participants' performances on
early lists in all of the other order manipulation conditions were
indistinguishable from performance on the early feature rich lists (\DIFdelbegin \DIFdel{$\|t\|$s
$< 1.013, p$s $> 0.314$}\DIFdelend \DIFaddbegin \DIFadd{$|t|$s
$\leq 1.013, p$s $\geq 0.314$}\DIFaddend ). Participants in both of the semantically
ordered conditions exhibited stronger temporal clustering on early lists
(versus early feature rich lists; category: \DIFdelbegin \DIFdel{$t(95) = 8.508, p <
0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(95) = 8.813, p < 0.001, d =
1.936, \mathrm{CI} = [6.793, 11.751] $}\DIFaddend ; size: \DIFdelbegin \DIFdel{$t(95) = 2.429, p = 0.017$}\DIFdelend \DIFaddbegin \DIFadd{$t(95) = 2.630, p = 0.010, d =
0.578, \mathrm{CI} = [0.831, 4.866]$; Fig.~\ref{fig:barplots}B}\DIFaddend ). Participants
in the length-ordered condition tended to exhibit \textit{less} temporal
clustering on early lists relative to early feature rich lists (\DIFdelbegin \DIFdel{$t(95) = -1.666, p = 0.099$}\DIFdelend \DIFaddbegin \DIFadd{$t(95) =
-1.547, p = 0.125, d = -0.340, \mathrm{CI} = [-3.693, 0.341]$}\DIFaddend ), whereas
participants in the first letter-ordered condition exhibited stronger temporal
clustering on early lists (\DIFdelbegin \DIFdel{$t(95) = 2.587, p = 0.011$}\DIFdelend \DIFaddbegin \DIFadd{$t(95) = 2.858, p = 0.005, d = 0.628, \mathrm{CI} =
[1.031, 4.886]$}\DIFaddend ). Participants in the visually ordered conditions exhibited
more similar performance \DIFaddbegin \DIFadd{(accuracy) }\DIFaddend on early lists, relative to early feature
rich lists (\DIFdelbegin \DIFdel{color: $t(96) = -1.064, p = 0.290$; }\DIFdelend \DIFaddbegin \DIFadd{we found a trending enhancement for participants in the
...
0.394]$, }\DIFaddend we found a trending \DIFdelbegin \DIFdel{enhancement }\DIFdelend \DIFaddbegin \DIFadd{increase }\DIFaddend for participants in the location-ordered
condition: \DIFdelbegin \DIFdel{$t(95) = 1.682, p = 0.096$}\DIFdelend \DIFaddbegin \DIFadd{$t(95) = 1.705, p = 0.092, d = 0.374, \mathrm{CI} = [-0.155,
3.521]$}\DIFaddend ). We also compared feature-based clustering on early lists across the
...
condition (category: \DIFdelbegin \DIFdel{$t(125) = 2.524, p =
0.013$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 2.722, p = 0.007, d = 0.484, \mathrm{CI} =
[0.827, 4.932]$}\DIFaddend ; size: \DIFdelbegin \DIFdel{$t(125) = 3.510, p = 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 3.866, p < 0.001, d = 0.687, \mathrm{CI} =
[2.020, 5.983]$}\DIFaddend ), but showed no reliable differences in lexicographic (length:
\DIFdelbegin \DIFdel{$t(125) = 0.539, p = 0.591$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.521, p = 0.603, d = 0.093, \mathrm{CI} = [-1.311, 2.333]$}\DIFaddend ; first
letter: \DIFdelbegin \DIFdel{$t(125) =
-0.587, p = 0.558$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = -0.842, p = 0.401, d = -0.150, \mathrm{CI} = [-2.825,
1.095]$}\DIFaddend ) or visual (color: \DIFdelbegin \DIFdel{$t(125) = -0.579, p = 0.564$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = -0.650, p = 0.517, d = -0.116, \mathrm{CI}
= [-2.680, 1.249]$}\DIFaddend ; location: \DIFdelbegin \DIFdel{$t(125) = -0.346, p = 0.730$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = -0.251, p = 0.802, d = -0.045,
\mathrm{CI} = [-2.257, 1.524]$}\DIFaddend ) clustering. Similarly, participants in the
lexicographically ordered conditions exhibited stronger (relative to feature
rich participants) lexicographic clustering (length: \DIFdelbegin \DIFdel{$t(125) = 3.426, p =
0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 3.682, p <
0.001, d = 0.655, \mathrm{CI} = [1.890, 5.569]$}\DIFaddend ; first letter: \DIFdelbegin \DIFdel{$t(125) = 3.236, p = 0.002$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 5.134,
p < 0.001, d = 0.912, \mathrm{CI} = [3.251, 7.258]$}\DIFaddend ) on early lists, but showed
no reliable differences in semantic (category: \DIFdelbegin \DIFdel{$t(125) = -1.078, p = 0.283$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = -1.040, p = 0.301, d =
-0.185, \mathrm{CI} = [-3.095, 1.092]$}\DIFaddend ; size: \DIFdelbegin \DIFdel{$t(125) = -0.310, p = 0.757$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.006, p = 0.995, d =
0.001, \mathrm{CI} = [-1.933, 1.952]$}\DIFaddend ) or visual (color: \DIFdelbegin \DIFdel{$t(125) = -0.209, p =
0.835$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.092, p =
0.927, d = 0.016, \mathrm{CI} = [-1.834, 1.867]$}\DIFaddend ; location: \DIFdelbegin \DIFdel{$t(125) = -0.004, p = 0.997$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.407, p
= 0.685, d = 0.072, \mathrm{CI} = [-1.655, 2.463]$}\DIFaddend ) clustering. And
...
color: \DIFdelbegin \DIFdel{$t(126) =
2.099, p = 0.038$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 2.022, p = 0.045, d = 0.358, \mathrm{CI} = [0.056, 3.965]$}\DIFaddend ;
location: \DIFdelbegin \DIFdel{$t(126) = 4.392, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 4.390, p < 0.001, d = 0.777, \mathrm{CI} = [2.730, 6.199]
$}\DIFaddend ), but showed no reliable differences in semantic (category: \DIFdelbegin \DIFdel{$t(126) = 0.204, p = 0.839$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 0.012,
p = 0.991, d = 0.002, \mathrm{CI} = [-1.988, 1.871]$}\DIFaddend ; size: \DIFdelbegin \DIFdel{$t(126) = -0.093, p = 0.926$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = -0.104, p
= 0.917, d = -0.018, \mathrm{CI} = [-2.166, 1.847] $}\DIFaddend ) or lexicographic (length:
\DIFdelbegin \DIFdel{$t(126) = 0.714, p =
0.476$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 0.592, p = 0.555, d = 0.105, \mathrm{CI} = [-1.361, 2.420]$}\DIFaddend ; first
letter: \DIFdelbegin \DIFdel{$t(126) = 0.820, p = 0.414$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 0.040, p = 0.968, d = 0.007, \mathrm{CI} = [-1.791, 1.863]$}\DIFaddend )
...
visual manipulations enhanced visual clustering\DIFaddbegin \DIFadd{; Fig.~\ref{fig:barplots}C}\DIFaddend )
...
clustering, and so on). \DIFaddbegin \DIFadd{Although it is not possible to fully separate feature
...
}\textit{\DIFadd{Factoring out the effects of temporal clustering}}\DIFadd{). When we carried out
...
across-participant \DIFdelbeginFL \DIFdelFL{distributions of }\DIFdelendFL clustering scores for each feature type ($x$-coordinate) are
displayed for each experimental condition (color), separately for order
manipulation (early, top) and randomly ordered (late, bottom) lists. \DIFaddbeginFL \DIFaddFL{Error bars
...
(\DIFdelbegin \DIFdel{$t(118) = 1.936, p = 0.055$}\DIFdelend \DIFaddbegin \DIFadd{$t(118) = 1.936, p = 0.055, d = 0.353, \mathrm{CI} = [0.057, 3.916]$}\DIFaddend ).
Participants also remembered visually sorted lists better than
lexicographically sorted lists (\DIFdelbegin \DIFdel{$t(119) = 2.145, p = 0.034$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 2.145, p = 0.034, d = 0.390,
\mathrm{CI} = [0.208, 4.254]$}\DIFaddend ). However, participants showed no reliable
differences in recall for semantically versus visually sorted lists (\DIFdelbegin \DIFdel{$t(119) = 0.113, p = 0.910$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) =
0.113, p = 0.910, d = 0.021, \mathrm{CI} = [-1.987, 2.097]$}\DIFaddend ). Participants
temporally clustered semantically sorted lists more strongly than either
lexicographically (\DIFdelbegin \DIFdel{$t(118) = 5.572, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(118) = 5.620, p < 0.001, d = 1.026, \mathrm{CI} = [3.486,
8.010]$}\DIFaddend ) or visually (\DIFdelbegin \DIFdel{$t(119) = 6.215, p
< 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 6.613, p < 0.001, d = 1.202, \mathrm{CI} =
[4.481, 9.464]$}\DIFaddend ) sorted lists, but did not show reliable differences in
temporal clustering on lexicographically versus visually sorted lists (\DIFdelbegin \DIFdel{$t(119) = 0.189,
p = 0.850$}\DIFdelend \DIFaddbegin \DIFadd{$t(119)
= 0.589, p = 0.557, d = 0.107, \mathrm{CI} = [-1.336, 2.539]$}\DIFaddend ). Participants
also showed reliably more semantic clustering on semantically sorted lists than
lexicographically (category: \DIFdelbegin \DIFdel{$t(118) = 3.492, p
= 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(118) = 3.667, p < 0.001, d = 0.670, \mathrm{CI}
= [1.822, 5.942]$}\DIFaddend , size: $t(118) = 3.972, p < 0.001$) or visually (category:
$t(119) = 2.702, p = 0.008$, size: \DIFdelbegin \DIFdel{$t(119) = 4.230, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(118) = 4.043, p < 0.001, d = 0.738,
\mathrm{CI} = [2.145, 6.296]$}\DIFaddend ) sorted lists; more lexicographic clustering on
lexicographically sorted lists than semantically (length: \DIFdelbegin \DIFdel{$t(118) = 3.112, p = 0.002$}\DIFdelend \DIFaddbegin \DIFadd{$t(118) = 3.390, p <
0.001, d = 0.619, \mathrm{CI} = [1.499, 5.661]$}\DIFaddend ; first letter: \DIFdelbegin \DIFdel{$t(118) = 3.686, p <
0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(118) = 5.705,
p < 0.001, d = 1.042, \mathrm{CI} = [3.841, 7.790]$}\DIFaddend ) or visually (length:
\DIFdelbegin \DIFdel{$t(119) = 3.024, p = 0.003$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 3.399, p < 0.001, d = 0.618, \mathrm{CI} = [1.500, 5.527]$}\DIFaddend ; first
letter: \DIFdelbegin \DIFdel{$t(119)
= 2.644, p = 0.009$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 4.859, p < 0.001, d = 0.883, \mathrm{CI} = [2.860, 6.849]$}\DIFaddend )
sorted lists; and more visual clustering on visually sorted lists than
semantically (color: \DIFdelbegin \DIFdel{$t(119) = -2.659, p = 0.009$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 2.673, p = 0.009, d = 0.486, \mathrm{CI} =
[0.848, 4.567]$}\DIFaddend ; location: \DIFdelbegin \DIFdel{$t(119) = -4.604, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 4.499, p < 0.001, d = 0.818, \mathrm{CI} =
[2.721, 6.399]$}\DIFaddend ) or lexicographically (color: \DIFdelbegin \DIFdel{$t(119) = -2.366, p
= 0.020$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 1.988, p = 0.049, d =
0.361, \mathrm{CI} = [0.102, 3.894]$}\DIFaddend ; location: \DIFdelbegin \DIFdel{$t(119) = -4.265, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$t(119) = 3.966, p < 0.001, d =
0.721, \mathrm{CI} = [2.099, 5.862]$}\DIFaddend ) sorted lists. In summary, sorting lists
...
(semantic: \DIFdelbegin \DIFdel{$t(125) = 0.487, p = 0.627$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.487, p = 0.627, d = 0.087, \mathrm{CI} = [-1.661,
2.323]$}\DIFaddend ; lexicographic: \DIFdelbegin \DIFdel{$t(125) = 0.878, p =
0.382$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.878, p = 0.382, d = 0.156, \mathrm{CI} =
[-1.226, 3.044]$}\DIFaddend ; visual: \DIFdelbegin \DIFdel{$t(126) = 1.437, p = 0.153$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 1.437, p = 0.153, d = 0.254, \mathrm{CI} =
[-0.447, 3.519]$}\DIFaddend ). Nor did we observe any reliable differences in temporal
clustering on late lists (relative to late feature rich lists; semantic:
\DIFdelbegin \DIFdel{$t(125) = 0.146, p = 0.884$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.157, p = 0.875, d = 0.028, \mathrm{CI} = [-1.859, 1.974]$}\DIFaddend ;
lexicographic: \DIFdelbegin \DIFdel{$t(125) = 0.923, p
= 0.358$}\DIFdelend \DIFaddbegin \DIFadd{$t(125) = 0.998, p = 0.320, d = 0.177, \mathrm{CI} = [-0.902,
2.920]$}\DIFaddend ; visual: \DIFdelbegin \DIFdel{$t(126) = 0.525, p = 0.601$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 0.548, p = 0.585, d = 0.097, \mathrm{CI} = [-1.450,
2.365]$}\DIFaddend ). Aside from a slightly increased tendency for participants to cluster
words by their length on late visual order manipulation lists (more than late
feature rich lists; \DIFdelbegin \DIFdel{$t(126) = 2.199, p =
0.030$}\DIFdelend \DIFaddbegin \DIFadd{$t(126) = 2.005, p = 0.047, d = 0.355, \mathrm{CI} =
[0.211, 3.722]$}\DIFaddend ), we observed no reliable differences in any type of feature
clustering on late order manipulation condition lists versus late feature rich
lists (\DIFdelbegin \DIFdel{$\|t\|$s $\leq 1.234, p$s $\geq 0.220$}\DIFdelend \DIFaddbegin \DIFadd{$|t|$s $\leq 1.124, p$s $\geq 0.263$}\DIFaddend ).
...
\begin{figure}[tp] \centering
    ...
    fingerprints to the \DIFdelbeginFL \DIFdelFL{list 0 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{average }\DIFaddendFL fingerprint \DIFaddbeginFL \DIFaddFL{across all prior lists}\DIFaddendFL , for each
...
0.010$}\DIFdelend \DIFaddbegin \DIFadd{$r(4) = 0.064, p = 0.903, \mathrm{CI} = [-0.972,$}\DIFaddend ). Taken together,
...
order manipulations (but not other manipulations) also tended to show a \DIFdelbegin \DIFdel{larger improvement in recall }\DIFdelend \DIFaddbegin \DIFadd{smaller
...
\DIFaddbegin \DIFadd{We note that the multivariate aspect of the adaptive condition (i.e., sorting
...
\citep{CofeEtal66, DAgo69, Dall64, Shap70, ShapPalm70, Kint70,
BoweEtal68, BoweEtal69, LuekEtal71, Puff74}}\hskip0pt%DIFAUXCMD
...
https://cdl-quail.read\-the\-docs.io/\-en/\-latest/\DIFaddbegin \DIFadd{.  Note that this study was not
preregistered.  Some of the ideas and data presented in this manuscript
were also presented at the Annual Meeting of the Society for Neuroscience (2017)}\DIFaddend .
