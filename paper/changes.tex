...
%DIF ADD main.tex   Tue Nov 21 00:58:18 2023
...
}\DIFdelend \DIFaddbegin \DIFadd{vectors and }\DIFaddend $(x, y)$ location vectors \DIFaddbegin \DIFadd{(specified as percentages of screen width
and height)}\DIFaddend , respectively. Therefore, the color and location distance measures
always take on non-negative real values (upper-bounded at \DIFdelbegin \DIFdel{441.67 }\DIFdelend \DIFaddbegin \DIFadd{439.94 }\DIFaddend for color, or
\DIFdelbegin \DIFdel{27~in }\DIFdelend \DIFaddbegin \DIFadd{124.52 }\DIFaddend for location, reflecting the distances between the corresponding
...
(all lists).}} \DIFaddFL{The $t$-tests reported in the table were carried out
...
feature-rich condition.}} \DIFaddFL{The $t$-tests reported in the table were carried out
...
\caption{\textbf{\DIFaddFL{Comparing memory for early versus late lists in the
reduced condition.}} \DIFaddFL{The $t$-tests reported in the table were carried out
across-participants. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing memory for early versus late lists in the
reduced (early) condition.}} \DIFaddFL{The $t$-tests reported in the table were carried out
across-participants. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing memory for early versus late lists in the
reduced (late) condition.}} \DIFaddFL{The $t$-tests reported in the table were carried out
across-participants. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
conditions (all lists).}} \DIFaddFL{The $t$-tests reported in the table were carried out
across-participants, and reflect data aggregated across all lists from each
participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
...
\caption{\textbf{\DIFaddFL{Comparing temporal clustering on early lists in the order manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing feature-based clustering on early lists in the semantic order manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing feature-based clustering on early lists in the lexicographic order manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing feature-based clustering on early lists in the visual order manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing accuracy on early lists in different order manipulation
conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing temporal clustering on early lists in different order manipulation
conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing feature-based clustering on early lists in different order manipulation
conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all early lists
...
\caption{\textbf{\DIFaddFL{Comparing accuracy on late lists in order-manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
...
\caption{\textbf{\DIFaddFL{Comparing temporal clustering on late lists in order-manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all late
lists from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing feature-based clustering on late lists in semantic order-manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all late
lists from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
\caption{\textbf{\DIFaddFL{Comparing feature-based clustering on late lists in visual order-manipulation
versus feature-rich conditions.}} \DIFaddFL{The $t$-tests reported in the table were
carried out across-participants, and reflect data aggregated across all late
lists from each participant. Abbreviations used in this table are defined in
Table~\abbreviations.}}
...
feature clustering on early lists \DIFdelbegin \DIFdel{trended towards showing }\DIFdelend \DIFaddbegin \DIFadd{showed }\DIFaddend stronger temporal
clustering on later lists (overall: \DIFdelbegin \DIFdel{$r(179) = 0.301, p < 0.001$}\DIFdelend \DIFaddbegin \DIFadd{$r(179) = 0.464,~p < 0.001,~\mathrm{CI} =
[0.321, 0.582]$}\DIFaddend ; for individual conditions: all $r$s \DIFdelbegin \DIFdel{$\geq 0.297$}\DIFdelend \DIFaddbegin \DIFadd{$\geq 0.377$}\DIFaddend , all $p$s
\DIFdelbegin \DIFdel{$\leq 0.111$}\DIFdelend \DIFaddbegin \DIFadd{$\leq 0.040$}\DIFaddend ; across conditions: \DIFdelbegin \DIFdel{$
r(4) = 0.107, p = 0.840$}\DIFdelend \DIFaddbegin \DIFadd{$ r(4) = 0.451,~p = 0.369,~\mathrm{CI} =
[-0.986, 0.998]$}\DIFaddend ). And participants who showed stronger temporal clustering on
early lists trended towards showing stronger feature clustering on later lists
(overall: \DIFdelbegin \DIFdel{$r(179) = 0.579, p < 0.001$; }\DIFdelend \DIFaddbegin \DIFadd{$r(179) = 0.266,~p < 0.001,~\mathrm{CI} = [0.129, 0.396]$; for
individual conditions: }\DIFaddend all \DIFdelbegin \DIFdel{non-visual
conditions: }\DIFdelend $r$s \DIFdelbegin \DIFdel{$\geq 0.323$, all $p$s $\leq 0.082$; visual conditions: $r$s
$\geq 0.089$}\DIFdelend \DIFaddbegin \DIFadd{$\geq 0.298$}\DIFaddend , all $p$s \DIFdelbegin \DIFdel{$\leq 0.632$}\DIFdelend \DIFaddbegin \DIFadd{$\leq 0.110$}\DIFaddend ; across
conditions: \DIFdelbegin \DIFdel{$r(4) = 0.916, p =
0.010$}\DIFdelend \DIFaddbegin \DIFadd{$r(4) = 0.064,~p = 0.903,~\mathrm{CI} = [-0.972,~0.965$}\DIFaddend ). Taken together,
